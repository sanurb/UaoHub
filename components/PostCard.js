...
import ClickOutHandler from '@components/hoc/ClickOutHandler';
			...
			<div className="flex gap-3">
				...
				<div className="relative">
					...
					<ClickOutHandler onClickOut={handleClickOutsideDropdown}>
						<div className="relative">
							{dropdownOpen && (
								<div className="dark:bg-slate-800 dark:shadow-gray-800 dark:border-slate-700 absolute -right-6 bg-white shadow-md shadow-gray-300 p-3 rounded-sm border border-gray-100 w-52 z-50">
				...
				{comments.length > 0 &&
					comments.map((comment) => (
						<div key={comment.id} className="mt-2 flex gap-2 items-center">
							...
							<div className="bg-gray-200 dark:bg-sky-500/[.06] py-2 px-4 rounded-3xl">
								<div>
